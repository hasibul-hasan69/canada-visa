...
<div class="information">
   <img src="{{'data:image/png;base64,' . base64_encode(file_get_contents(@$dataInfo->companyInfo->header))}}" alt="image" style="width:795px;">
</div>
   ...
   <table style="width:95%; ">
    <tr>
        <td style="font-weight: bolder; font-size: 16px;">
            <span>To<span><br>
            <span>{{$dataInfo->name}}<span><br>
            <span>Passport No: {{$dataInfo->passportNo}}<span><br>
...
<table  style="width:95%; ">
    <tr>
        <th style="text-align:  left; font-size: 14px; font-weight: bold;">Greetings!</th>
        <td style="text-align:  right; font-size: 14px;">{{date_format(date_create($dataInfo->appointDate),'d F Y')}}</td>
    </tr>
</table>
