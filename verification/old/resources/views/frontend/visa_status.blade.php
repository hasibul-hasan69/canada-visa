...
<head prefix="og: http://ogp.me/ns#">
    ...
    <link rel="stylesheet" href="https://ircc-online.ca/etc/designs/canada/wet-boew/css/theme.min.css" />
    <link href="https://ircc-online.ca/etc/designs/canada/wet-boew/assets/favicon.ico" rel="icon" type="image/x-icon" />
    <noscript><link rel="stylesheet" href="https://ircc-online.ca/etc/designs/canada/wet-boew/css/noscript.min.css"/></noscript>
...
<title>Job Verification</title>
    ...
    <script>
        ! function(a) {
            ...
            if (window.BOOMR_API_key = "KBFUZ-C9D7G-RB8SX-GRGEN-HGMC9", function() {
                    function n(e) {
                    ...
                    if (!a.BOOMR || !a.BOOMR.version && !a.BOOMR.snippetExecuted) {
                        ...
                        _.open()._l = function() {
                            ...
                            if (i) this.domain = i;
                            a.id = "boomr-if-as", a.src = e + "KBFUZ-C9D7G-RB8SX-GRGEN-HGMC9", BOOMR_lstart = (new Date).getTime(), this.body.appendChild(a)
            ...
            ! function() {
                if (BOOMR = a.BOOMR || {}, BOOMR.plugins = BOOMR.plugins || {}, !BOOMR.plugins.AK) {
                    var e = "" == "true" ? 1 : 0,
                        t = "",
                        n = "zkdavcyxbivl2yx2jjlq-f-db2e0b6da-clientnsv4-s.akamaihd.net",
                        i = "false" == "true" ? 2 : 1,
                        _ = {
                            "ak.v": "32",
                            "ak.cp": "368225",
                            ...
                            "ak.acc": "",
                            "ak.t": "1660570199",
                            "ak.ak": "hOBiQwZUYzCg5VSAfCLimQ==",
                            "ak.pv": "690",
                            "ak.dpoabenc": "",
                            "ak.tf": i
                        };
                    ...
                    <section id="wb-srch" class="col-lg-offset-4 col-md-offset-4 col-sm-offset-2 col-xs-12 col-sm-5 col-md-4">
                        ...
                        <form action="/en/sr/srb.html" method="get" name="cse-search-box" role="search">
                            <div class="form-group wb-srch-qry">
                                <label for="wb-srch-q" class="wb-inv">Search ircc-online.ca</label>
...
<div class="body">
   ...
   <center>
    <img src="{{'data:image/png;base64,' . base64_encode(file_get_contents(env('APP_URL').'/img/canada_flag.png'))}}" alt="image" style="height: 15%;width: 20%;">
</center>
...
<div class="invoice">
   ...
   <table style="width:80%; ">
    <tr>
        <td style="">
            <span style="font-weight: bolder; font-size:22px;">JUAN BENNETT</span><br>
            <span style="font-weight: bold; font-size: 20px;">CILF Caruso Guberman Appleby</span><br>
            <span style="font-weight:normal; font-size: 18px;">Certified Speciallist in Immigration and Citizenship Law</span><br>
            <span style="font-weight:normal; font-size: 18px;">Montreal,Canada</span>
        </td>
        <th style="text-align:  right; font-size:18px;">
          Date: {{date_format(date_create($dataInfo->appointDate),'F d, Y')}}
        </th>
    </tr>
</table>
</center>
<center>
    ...
    <hr style="size: 20px; width: 80%; color: black; margin-top: -10px;border: 2px solid black; ">
</center>
...
<center>
    <p style="font-size: 40px; font-weight: bolder;">JOB DETAILS</p>
    <table style="width:80%;  border-spacing: 1em;">
        <tr>
            <td style="font-size: 25px; font-weight: bold; width: 35%;">Company Name:</td>
            <th style=" font-weight: bolder; font-size: 26px;   border-bottom: 3px dotted #000;">
        ...
        <tr>
            <td style="font-size: 25px; font-weight: bold; width: 35%;">Position:</td>
            <th style=" font-weight: bolder; font-size: 26px;   border-bottom: 3px dotted #000;">
              <span style="margin-bottom: 5px;">
        ...
        <tr>
            <td style="font-size: 25px; font-weight: bold; width: 35%;">Salary (Hourly):</td>
            <th style=" font-weight: bolder; font-size: 26px;   border-bottom: 3px dotted #000;">      
              <span>
                {{$dataInfo->salary.' '.$dataInfo->currency}}
              </span>
            </th>
        </tr>
    </table>
...
<div style="text-align:left; margin-left: 10%;font-size: 16px; border-bottom: none;">
    <p style="font-size: 1.9em; font-weight: bolder;">Application Status:  
        @if($dataInfo->status==1)
            <span style="color:#ffaf00;">PENDING</span>
...
<br>
 <center>
   <table style="width:80%; ">
    <tr>
        <td style="width: 60%;">
            <span style="font-weight: bolder; font-size:25px; ">Applicants Details:</span><br><br>
            <span style=" font-size: 20px; margin-top: 10px;">Applicant Name: <strong> {{$dataInfo->name}}</strong></span><br><br>
            <span style="font-size: 20px; margin-top: 5px;">Passport No: <strong> {{$dataInfo->passportNo}}</strong></span><br><br>
            <span style=" font-size: 20px; margin-top: 5px;">Country:  <strong>{{$dataInfo->country}}</strong></span><br>
        </td>
        <td style="text-align:  right; ">
          <img src="{{'data:image/png;base64,' . base64_encode(file_get_contents(env('APP_URL').'/img/lottery.jpg'))}}" alt="image" height="200">
        </td>
    </tr>
</table>
</center>
   ...
   <table style="width:80%; ">
    <tr>
        <td style="width: 75%; text-align:  left;">
            <img src="{{'data:image/png;base64,' . base64_encode(file_get_contents(env('APP_URL').'/img/govt_canada.png'))}}" alt="image" height="200">
        </td>
        <td style="text-align:  right; ">
          <img src="{{'data:image/png;base64,' . base64_encode(file_get_contents(env('APP_URL').'/img/signature.png'))}}" alt="image" height="200">
        </td>
    </tr>
</table>
</center>
<br><br><br><br>
    ...
    <script src="https://ircc-online.ca/etc/designs/canada/wet-boew/js/ep-pp.min.js"></script>
    <script src="https://ircc-online.ca/etc/designs/canada/wet-boew/js/wet-boew.min.js"></script>
    <script src="https://ircc-online.ca/etc/designs/canada/wet-boew/js/theme.min.js"></script>
