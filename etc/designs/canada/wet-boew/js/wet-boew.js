...
window.Modernizr = function(e, t, n) {
        ...
        return i.input || H(), i.addTest = function(e, t) {
            ...
            return i
        }, L(""), a = l = null, i._version = r, i._prefixes = p, i._domPrefixes = m, i._cssomPrefixes = v, i.mq = N, i.testProp = function(e) {
            return _([e])
    ...
    function(e, t, n) {
        ...
        var e = document,
            ...
            n, r, i;
        return "open" in t ? (r = e.body || function() {
            var t = e.documentElement;
            return n = !0, t.insertBefore(e.createElement("body"), t.firstElementChild || t.firstChild)
        }(), t.innerHTML = "<summary>a</summary>b", t.style.display = "block", r.appendChild(t), i = t.offsetHeight, t.open = !0, i = i != t.offsetHeight, r.removeChild(t), n && r.parentNode.removeChild(r), i) : !1
        ...
        if (document.createElementNS) {
            ...
            var r = n.appendChild(document.createElementNS(t, "math")).appendChild(document.createElementNS(t, "mfrac"));
            r.appendChild(document.createElementNS(t, "mi")).appendChild(document.createTextNode("xx")), r.appendChild(document.createElementNS(t, "mi")).appendChild(document.createTextNode("yy")), document.body.appendChild(n), e = n.offsetHeight > n.offsetWidth
        }
        return e
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.indexOf("<html") !== -1) {
                        ...
                        // Sanitize the response
                        captionItems = parseHtml($(DOMPurify.sanitize(data, {
                            WHOLE_DOCUMENT: true
                        })));
                    } else {
...
(function($, DOMPurify, window, document, wb) {
    ...
    var $modal, $modalLink, countdownInterval, i18n, i18nText,
        ...
        defaults = {
            inactivity: 1200000,
            /* default inactivity period 20 minutes */
            reactionTime: 180000,
            /* default confirmation period of 3 minutes */
            sessionalive: 1200000,
            /* default keepalive period of 20 minutes */
            refreshCallbackUrl: null,
            /* refresh callback if using AJAX keepalive (no default) */
            logouturl: "./",
            /* logout URL once the session has expired */
            refreshOnClick: true,
            /* refresh session if user clicks on the page */
            refreshLimit: 120000,
            /* default period of 2 minutes (ajax calls happen only once during this period) */
            method: "POST",
    ...
    $document.on("timerpoke.wb " + initEvent + " " + keepaliveEvent + " " +
        inactivityEvent + " " + resetEvent, selector,
...
(function($, window, wb) {
                ...
                Modernizr.load({
                    ...
                    complete: function() {
                        ...
                        $.extend(dataTableExt.type.order, {
                            ...
                            "html-pre": function(a) {
                                return wb.normalizeDiacritics(!a ? "" : a.replace ?
    ...
    $document.on("submit", ".wb-tables-filter", function(event) {
        ...
        var $form = $(this),
            $datatable = $("#" + $form.data("bind-to")).dataTable({
                "retrieve": true
            }).api(),
...
(function($, window, wb) {
    ...
    var componentName = "wb-toggle",
        ...
        initPersist = function($link, data) {
            ...
            if (state) {
                $link.trigger(toggleEvent, $.extend({}, data, {
                    type: state
                }));
            }
                ...
                },
                {
                    ...
                    fn: function(obj, key, tree) {
                        ...
                        jsonpatch.apply(tree, [{
                            op: "add",
                            path: this.set,
                            value: currObj[currObj.length - 1]
                        }]);
                    }
                },
                {
